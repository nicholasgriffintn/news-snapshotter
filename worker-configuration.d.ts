/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1fb17e24430a31c0a7c8b8bc5cfe2987)
// Runtime types generated with workerd@1.20260710.1 2026-06-16 nodejs_compat
interface __BaseEnv_Env {
	CAPTURE_FAILURES: KVNamespace;
	...
	COMPARISON_FEEDBACK_RATE_LIMIT: RateLimit;
	BROWSER: BrowserRun;
	AI: Ai;
	COMPARISON_CANARY_MODEL: "";
	COMPARISON_CANARY_PERCENT: "0";
	API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<
			Cloudflare.Env,
			"COMPARISON_CANARY_MODEL" | "COMPARISON_CANARY_PERCENT" | "API_KEY" | "HYPERBROWSER_API_KEY"
		>
	> {}
}
